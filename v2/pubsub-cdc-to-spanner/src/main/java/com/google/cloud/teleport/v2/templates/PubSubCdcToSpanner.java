...
import com.google.cloud.teleport.v2.transforms.FormatStriimJsonToJson;
 ...
 * </pre>
 */
public class PubSubCdcToSpanner {

  private static final Logger LOG = LoggerFactory.getLogger(PubSubCdcToSpanner.class);
  ...
  public interface Options extends PipelineOptions, StreamingOptions {
    @Description(
      "The Cloud Pub/Sub subscription to consume Striim CDC changes from. "
  ...
  public static void main(String[] args) {
    LOG.info("Starting Pub/Sub CDC to Cloud Spanner");
  ...
  public static PipelineResult run(Options options) {
     ...
     *   b) Read CDC changes from Pub/Sub subscription into JSON String FailsafeElements
     *   c) Reconsume Dead Letter Queue data from GCS into JSON String FailsafeElements
     *   d) Flatten CDC and DLQ Streams
     */
    ...
    PCollection<FailsafeElement<String, String>> striimJsonRecords =
        messages
            .apply(
                "ExtractPubsubMessagePayloads",
                ParDo.of(
            ...
            .apply(
                "ParseJsonRecords",
                ParDo.of(
                    (FormatStriimJsonToJson)
                    FormatStriimJsonToJson.create()
    ...
    PCollection<FailsafeElement<String, String>> jsonRecords =
    PCollectionList.of(striimJsonRecords)
        .and(dlqJsonRecords)
        .apply(Flatten.pCollections())
        .apply("Reshuffle", Reshuffle.viaRandomKey());
